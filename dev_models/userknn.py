...
class UserKnn:
    ...
    # users_inv_mapping: Dict[int, str]
    # users_mapping_static: Dict[str, int]
    # items_inv_mapping: Dict[int, Any]
    # items_mapping: Dict[Any, Any]
    ...
    def __init__(self, model: ItemItemRecommender, popular_model: PopularModel, N_users: int = 70):
        ...
        # self.item_idf_static = None
        # self.watched_static = None
        # self.users_inv_mapping_static = None
        # self.user_knn_static = None
        # self.users_mapping_static = None
    ...
    def fit(self, train_dataset: Dataset):
        ...
        # get one sample id
        self.popular_model.fit(deepcopy(train_dataset))

        # train userKNN
        train = deepcopy(train_dataset.interactions.df)
